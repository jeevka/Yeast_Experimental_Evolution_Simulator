...
def asymmetrical_cell_division(genotypes,cell_groups,PM_fitness,PM,n_generations,n_BN,n_individuals,n_mut,s_size,dps,FAMR,mutation_fitness,mutation_rate,BMR,cell_max_age):
    ...
    for i in xrange(n_BN):
        ...
        if i != n_BN-1: 
            ...
            calculate_mutation_frequencies(PM,i,n_individuals,Mut_Freq,Mean_Mut,n_BN)
            ...
            print "Number of Mutations",n_mut
...
##############################################################################################
cdef calculate_mutation_frequencies(PM,N_BN,N,Mut_Freq,Mean_Mut,Total_BN):
    Freq = {}
    N_mut = 0
